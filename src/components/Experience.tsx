...
export default () => (
  <section className="flex min-h-0 flex-col gap-y-3">
    ...
    <div className="rounded-lg bg-card text-card-foreground">
      ...
      <div className="text-pretty font-mono text-muted-foreground mt-2 text-xs">
        During my time at Hotmart, I worked as a senior frontend developer in two large projects. The first was focused
        on user privacy, creating internal applications in React with TypeScript and features in existing products for
        end users, using Next, Meteor, and Vue.js to meet all demands of legislation such as GDPR, LGPD, cookie policy,
        etc. In the second project, I worked on a product vital for Hotmart business. Our stack included React, Redux,
        Cypress, Vitest, and Meteor.
      </div>
    </div>
    <hr />
    <div className="rounded-lg bg-card text-card-foreground">
      ...
      <div className="text-pretty font-mono text-muted-foreground mt-2 text-xs">
        ...
        the world. We worked with a mix of recent technologies such as .NET Core (serverless), Protocol Buffers, Redis,
        Cosmos DB, and micro frontends (React and Angular) alongside traditional technologies like Java, SQL Server, and
        Power BI. We focused heavily on agile methodologies and used Scrum with adaptations for the client reality.
      </div>
    </div>
    <hr />
    <div className="rounded-lg bg-card text-card-foreground">
      ...
      <div className="text-pretty font-mono text-muted-foreground mt-2 text-xs">
        ...
        applications from FIAT internal data centers to AWS, initially using Beanstalk, Docker, and later Kubernetes. At
        Volkswagen, I developed a chatbot orchestrator to assist users with various internal processes. This application
